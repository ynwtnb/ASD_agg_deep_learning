#!/bin/bash
#SBATCH --job-name=tcn_sweep6
#SBATCH --partition=gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=06:00:00
#SBATCH --array=0-7
#SBATCH --output=experiments/logs/tcn_sweep6_%A_%a.out
#SBATCH --error=experiments/logs/tcn_sweep6_%A_%a.err
...
SAVE_PATH="experiments/results/tcn/sweep6/${CONFIG_NAME}"
